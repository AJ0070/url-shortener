            ...
            urlList.innerHTML = urls.map(url => `
                <div class="url-item">
                    <div class="url-details">
                        <div class="short-url">${window.location.origin}/${url.shortUrl}</div>
                        <div class="original-url">${url.originalUrl}</div>
                    </div>
                    <div class="url-stats">
                        <span><i class="fas fa-clock"></i> ${new Date(url.createdAt).toLocaleDateString()}</span>
                        <span><i class="fas fa-click"></i> ${url.clicks} clicks</span>
                    </div>
                </div>
            `).join('');
        } catch (error) {
